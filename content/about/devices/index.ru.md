...
<section class="space-y-8">
  ...
  <div>
    ...
    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div class="flex max-w-prose items-center rounded-md border border-neutral-200 bg-white p-4 shadow dark:border-neutral-700 dark:bg-neutral-800">
        <div class="flex-none pe-4">
          <img src="/about/devices/img/mxmaster4b.webp" alt="Logitech MX Master 4" class="w-24 rounded-md">
        </div>
        <div>
          <div class="mt-2 list-disc pl-5 text-sm text-neutral-600 dark:text-neutral-400">{{< icon "mouse" >}} Мышь</div>
          <h2 class="text-xl mt-0 font-semibold text-neutral-800 dark:text-neutral mb-0">Logitech MX Master 4</h2>
          <div class="mt-2 pl-5 text-sm text-neutral-600 dark:text-neutral-400">Black</div>
        </div>
      </div>
      <div class="flex max-w-prose items-center rounded-md border border-neutral-200 bg-white p-4 shadow dark:border-neutral-700 dark:bg-neutral-800">
        <div class="flex-none pe-4">
          <img src="/about/devices/img/mxkeyssb.webp" alt="Logitech MX Keys S" class="w-24 rounded-md">
        </div>
        <div>
          <div class="mt-2 pl-5 text-sm text-neutral-600 dark:text-neutral-400">{{< icon "keyboard" >}} Клавиатура</div>
          <h2 class="text-xl mt-0 font-semibold text-neutral-800 dark:text-neutral mb-0">Logitech MX Keys S</h2>
          <div class="mt-2 pl-5 text-sm text-neutral-600 dark:text-neutral-400">Black</div>
        </div>
      </div>
      <div class="flex max-w-prose items-center rounded-md border border-neutral-200 bg-white p-4 shadow dark:border-neutral-700 dark:bg-neutral-800">
