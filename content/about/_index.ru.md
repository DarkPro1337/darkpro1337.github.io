...
Я инженер-программист, живу и работаю в Ереване. Использую **C# и .NET** для создания внутренних инструментов, автоматизации Windows-инфраструктуры и разработки backend-интеграций. Ранее занимался **WPF-приложениями** и инструментами для разработки игр. Мне нравится превращать сложные и рутинные процессы в надёжные и практичные программные решения.
...
{{< spotify type="track" id="68q3SgpQnsQEe7BnBAjIuA" width="100%" height="100" >}}
